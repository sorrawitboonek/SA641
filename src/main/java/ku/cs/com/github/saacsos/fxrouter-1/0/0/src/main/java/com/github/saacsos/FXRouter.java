...
public final class FXRouter {
    ...
    private static void loadNewRoute(RouteScene route) throws IOException {
        ...
        Parent resource = (Parent)FXMLLoader.load(Objects.requireNonNull((new Object() {
    ...
    public static Object getData2() { return currentRoute.data2; }

    public static String getPreviousPage() {
        return currentRoute.previousPage;
    }

    public static void setPreviousPage(String route) {currentRoute.previousPage = route;}

    public static String getcurrentPage() {return currentRoute.currentPage;}

    //public static void setcurrentPage(String route) {currentRoute.currentPage = route;}
